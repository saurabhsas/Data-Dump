...
# 🔥 FILTER MATCHED IDs AGAINST DATA (CRITICAL)
...
# DEBUG (REMOVE LATER)
# -----------------------------------
st.write("Matched G1:", matched["G1_MEMBER_ID"].nunique())
st.write("Matched G2:", matched["G2_MEMBER_ID"].nunique())

st.write("Dashboard G1:", g1_data["MEMBER_ID"].nunique())
st.write("Dashboard G2:", g2_data["MEMBER_ID"].nunique())
